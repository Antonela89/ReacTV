# 🎬 ReacTV - Streaming Platform Experience

ReacTV es una aplicación web inspirada en servicios de streaming como Netflix, desarrollada con **React.js**. El proyecto ofrece una experiencia integral que incluye autenticación de usuarios, consumo de datos en tiempo real y una interfaz moderna y responsiva.
...
1. Clona el repositorio:
   ```Bash
   git clone https://github.com/Antonela89/ReacTV.git
   ```
...
Proyecto colaborativo desarrollado por: Antonela Borgogno, Monica Irene Crichton, Fani Mariel Casco, y equipo.

✨ Proyecto desarrollado con fines educativos para demostrar habilidades en el ecosistema React.
